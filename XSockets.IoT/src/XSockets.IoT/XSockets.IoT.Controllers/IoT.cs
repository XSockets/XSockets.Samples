...
using XSockets.IoT.Controllers.Model;
...
namespace XSockets.IoT.Controllers
{
    ...
    public class IoT : XSocketController
    {
        ...
        /// <summary>
        /// Browser will call this and turn light on/off on the netduino/arduino
        /// Information will be sent to Netduinos only
        /// </summary>
        /// <param name="toggle"></param>        
        public void Light(Toggle toggle)
        {            
            this.InvokeTo(p => p.ClientType == toggle.ClientType, new {toggle.State},"light");
        }
